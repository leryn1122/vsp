...
use crate::ops::{clean, compile, debug, lint, new, ps, repl, run, stack, tar, test, CliHandler};
...
impl Config {
  /// Register `clap` subcommands and handlers to execute in the following stages.
  /// All subcommands are delegated to register through this method.
