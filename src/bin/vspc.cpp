...
int main(int argc, char *argv[]) {
  auto argparser =
      vsp::cli::ArgParser(CMD)
          ...
          .add_option("", "--deprecation",
                      "Locate where deprecated APIs are used.")
          ...
          .add_option<string>(
              "-p", "--profile",
              "Activate the specified profile to enable those APIs.", "default")
          ...
          .add_option<int>("-T", "--thread",
                           "Set the parallel thread to compile source.", 4)
